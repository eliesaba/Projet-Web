...
<html lang="en">
    ...
    <div class="section-header" >        
          <h2 class="section-title">Ministry Of Environement</h2>
        </div>
      </div>
   </section>  
...
$profile=GetMinistry("MinistryOfEnvironement");
$numberemp=GetMinistrynumberemp("MinistryOfEnvironement");
...
?>
                    ...
                    <img src="img/ministries/MOE.png"  alt="">                               
            </header>
