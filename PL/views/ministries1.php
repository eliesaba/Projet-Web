  ...
  <body>
   ...
   <section class="call-action section">
    <div class="container">
        <div class="section-header" >  
          ...
          <h2 class="section-title">All Ministries</h2>
        </div>
        <div class="row">
            <a href="MinistryOfEnvironement1.php" class="btn btn-common3 btn-effect wow fadeInUp">Ministry Of Environement</a>
            <a href="MinistryOfFinance1.php"  class="btn btn-common3 btn-effect wow fadeInUp">Ministry Of Finance</a>
        </div> 
      </div>    
   </section>
   ...
   <section class="call-action section">
    <div class="container">
        ...
        <div class="row">
            <a href="MinistryOfSocialaffairs1.php" class="btn btn-common3 btn-effect wow fadeInUp">Ministry Of Social Affairs</a>
            <a href="MinistryOfCulture1.php"  class="btn btn-common3 btn-effect wow fadeInUp">Ministry Of Culture</a>
        </div> 
      </div>    
   </section>   
