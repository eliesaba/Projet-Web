   ...
   <section class="call-action section">
    <div class="container">
        <div class="section-header" >  
          ...
          <h2 class="section-title">Manage Vacancies</h2>
        </div>
      </div>
   </section>   
            ...
            else
            {
                echo            
                 ...
                 for($i=0;$i<count($profiles);$i++)
                 {
                    echo                    
                        "<tr>"
                            ."<td>".$profiles[$i]->getTitle()."</td>"
                            ."<td>".$profiles[$i]->getMinistry()."</td>"
                            ."<td><a href='UpdateVacancie.php?id=".$profiles[$i]->getId()."'>Update</a></td>"
                            ."<td><a href='DeleteVacancie.php?id=".$profiles[$i]->getId()."'>Delete</a></td>"
                        ."</tr>";    
                }
             }
            ?>
