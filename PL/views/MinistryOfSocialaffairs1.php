...
<html lang="en">
    ...
    <div class="section-header" >        
          <h2 class="section-title">Ministry Of Social Affairs</h2>
        </div>
      </div>
   </section>  
...
$profile=GetMinistry("MinistryOfSocialaffairs");
$numberemp=GetMinistrynumberemp("MinistryOfSocialaffairs");
...
?>
                ...
                <img src="img/ministries/MOSA.png"  alt="">                               
            </header>
