...
<html lang="en">
    ...
    <div class="section-header" >        
          <h2 class="section-title">Ministry Of Finance</h2>
        </div>
      </div>
   </section>  
...
$profile=GetMinistry("MinistryOfFinance");
$numberemp=GetMinistrynumberemp("MinistryOfFinance");
...
?>
                    ...
                    <img src="img/ministries/MOF.png"  alt="">                               
            </header>
